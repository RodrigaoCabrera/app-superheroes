...
export default () => <HerosProvider><Hero /></HerosProvider>

const Hero = () => {
    const { obtenerHeroes, heros, eliminarHero } = useHeros();
                                        ...
                                        <div className="d-flex flex-column justify-content-between">
                                            <section>
                                                ...
                                                <div class="text-center" style={{ width: "100%", height: "9rem" }}>
                                                    <img className="text-center" alt="image de héroe" style={{ maxWidth: "100%", height: "9rem", borderRadius: "100%" }} src={hero.image.url} alt="" />
                                                </div>
                                            </section>
